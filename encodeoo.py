...
if (os.path.isdir(args.inputfile)):
    ...
    mediatools.utilities.debug(1, "%s ==> %s" % (args.inputfile, targetdir))
    ...
    if args.ranges is None:
        mediatools.videofile.encodeoo(args.inputfile, args.outputfile, args.profile, **options)
    else:
        ...
        for range in re.split(',', args.ranges):
            ...
            mediatools.videofile.encodeoo(args.inputfile, target_file, args.profile, **options)
